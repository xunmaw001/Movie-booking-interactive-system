 ...
 */
@TableName("yingpian_collection")
public class YingpianCollectionView extends YingpianCollectionEntity implements Serializable {
	...
	public YingpianCollectionView() {

	}

	public YingpianCollectionView(YingpianCollectionEntity yingpianCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, yingpianCollectionEntity);
