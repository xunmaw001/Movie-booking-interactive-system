...
public class YingpianLiuyanView extends YingpianLiuyanEntity implements Serializable {
	...
	public YingpianLiuyanView() {

	}

	public YingpianLiuyanView(YingpianLiuyanEntity yingpianLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, yingpianLiuyanEntity);
