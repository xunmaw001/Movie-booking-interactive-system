            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">票房推荐</span>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  yingpianList1111" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../yingpian/detail.jsp?id='+item.id)">
                                            <img :src="item.yingpianPhoto?item.yingpianPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.yingpianName}}</p>
                                            <p style="color: red;" v-if="item.yingpianNewMoney">{{item.yingpianNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../yingpian/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  yingpianList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../yingpian/detail.jsp?id='+item.id)">
                                            <img :src="item.yingpianPhoto?item.yingpianPhoto.split(',')[0]:''" width="300px" height="300px"/>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`yingpian/list`, 'get', {
            page: 1,
            limit: 6,
            flag: 1
        }, function (res) {
            vue.yingpianList = res.data.list;
        });
        http.request(`yingpian/list`, 'get', {
            page: 1,
            limit: 6,
            flag: 1,
            orderBy: "piaofang_number",
        }, function (res) {
            vue.yingpianList1111 = res.data.list;
        });
    });
</script>
