            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">影片展示</span>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../yingpian/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../yingpian/detail.jsp?id='+item.id)"><span>{{item.yingpianName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 yingpianContent 字段去除无用字符 如果字段长度大于60  就截取到60
            yingpianContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (jquery('#piaofangNumberEnd').val() != null && jquery('#piaofangNumberEnd').val() != "" && jquery('#piaofangNumberEnd').val() != "null" ) {
                param['piaofangNumberEnd'] = jquery('#piaofangNumberEnd').val();
                                    ...
                                    // 获取列表数据
            http.request('yingpian/list', 'get', param, function(res) {
