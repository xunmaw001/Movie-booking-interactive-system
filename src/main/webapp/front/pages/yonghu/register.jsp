            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">用户编号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yonghuDanhaoNumber" id="yonghuDanhaoNumber"  placeholder="用户编号"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
...
<!-- 手机号 -->
  ...
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">现住地址:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yonghuAddress" id="yonghuAddress"  placeholder="现住地址"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
