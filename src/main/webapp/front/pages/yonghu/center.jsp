				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yonghuDanhaoNumber" id="yonghuDanhaoNumber" lay-verify="required" placeholder="用户编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yonghuAddress" id="yonghuAddress" lay-verify="required" placeholder="现住地址" autocomplete="off" class="layui-input">
							</div>
						</div>
