    ...
    <div class="data-add-container">
        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.yonghuDanhaoNumber" type="text" name="yonghuDanhaoNumber" id="yonghuDanhaoNumber" placeholder="用户编号" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
...
<!-- 手机号 -->
        ...
        <!-- 身份证号 -->
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.yonghuAddress" type="text" name="yonghuAddress" id="yonghuAddress" placeholder="现住地址" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
