                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yonghuDanhaoNumber" id="yonghuDanhaoNumber" placeholder="用户编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yonghuPhone" id="yonghuPhone" placeholder="用户手机号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yonghuIdNumber" id="yonghuIdNumber" placeholder="用户身份证号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#yonghuDanhaoNumber').val() != null && jquery('#yonghuDanhaoNumber').val() != "" && jquery('#yonghuDanhaoNumber').val() != "null" ) {
                param['yonghuDanhaoNumber'] = jquery('#yonghuDanhaoNumber').val();
            }
